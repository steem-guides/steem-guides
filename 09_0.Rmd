...
### STEEMPEAK的PC版基本使用方法 ^[作者:\@minloulou;编辑:\@jianan;原文链接:https://steemit.com/steem-guides/@minloulou/steempeak-steempeak]
...
![](https://files.steempeak.com/file/steempeak/minloulou/O6r7PrIX-image.png)

(圖一)

![](https://files.steempeak.com/file/steempeak/minloulou/9XgbFrEP-image.png)

(圖二)

![](https://files.steempeak.com/file/steempeak/minloulou/u7mzP5YF-image.png)

(圖三)

![](https://files.steempeak.com/file/steempeak/minloulou/JxFz4Cnc-image.png)

(圖四)

![](https://files.steempeak.com/file/steempeak/minloulou/qZXxNxC3-image.png)

(圖五)


成功登入後，**你可以使用上方的標題開始探索(Feed/Explore)**
...
![](https://files.steempeak.com/file/steempeak/minloulou/OQ121Xux-image.png)

(圖六)

![](https://files.steempeak.com/file/steempeak/minloulou/nAV5a7tT-image.png)

(圖七)

![](https://files.steempeak.com/file/steempeak/minloulou/1qQdH8A1-image.png)

(圖八)

![](https://files.steempeak.com/file/steempeak/minloulou/gVuhIERD-image.png)

(圖九)


**在Steemit別忘了寫一寫、分享一下與其他人互動**
...
![](https://files.steempeak.com/file/steempeak/minloulou/4lQuGS3B-image.png)
(圖十)

![](https://files.steempeak.com/file/steempeak/minloulou/kESzC7Au-image.png)
(圖十一)
...
![](https://files.steempeak.com/file/steempeak/minloulou/zg3O5gG8-image.png)
(圖十二)

![](https://files.steempeak.com/file/steempeak/minloulou/uwC4Qvzy-image.png)
(圖十三)


**最後最後還有一個很重要的是支持開發者(SUPPORT US)，如果你用得開心，不妨將你收到的STEEM/SBD捐贈給開發者以支持他們繼續努力!!**

![](https://files.steempeak.com/file/steempeak/minloulou/JbiMWdr9-image.png)


### STEEMPEAK的手機版 ^[作者:\@minloulou;编辑:\@jianan;原文链接:https://steemit.com/steem-guides/@minloulou/25jqmd-steempeak-steempeak]

[齊齊來玩STEEMPEAK(一) STEEMPEAK的基本使用方法](https://steempeak.com/steem-guides/@minloulou/steempeak-steempeak)
...
![](https://files.steempeak.com/file/steempeak/minloulou/Z2hTcH1H-WhatsApp20Image202019-06-2920at2015.52.20.jpeg)

![](https://files.steempeak.com/file/steempeak/minloulou/u2pQKwMZ-WhatsApp20Image202019-06-2920at2015.52.21.jpeg)

![](https://files.steempeak.com/file/steempeak/minloulou/1FTIWwzQ-WhatsApp20Image202019-06-2920at2015.52.22.jpeg)

![](https://files.steempeak.com/file/steempeak/minloulou/GcrwTzYN-WhatsApp20Image202019-06-2920at2015.52.22201.jpeg)
...
![](https://files.steempeak.com/file/steempeak/minloulou/a2kr1eXR-WhatsApp20Image202019-06-2920at2015.52.23201.jpeg)

![](https://files.steempeak.com/file/steempeak/minloulou/PTspCZ4t-WhatsApp20Image202019-06-2920at2015.52.24.jpeg)

![](https://files.steempeak.com/file/steempeak/minloulou/Mw1SgUOl-WhatsApp20Image202019-06-2920at2015.52.25.jpeg)
...
![](https://files.steempeak.com/file/steempeak/minloulou/LA5MyhMp-WhatsApp20Image202019-06-2920at2015.52.23.jpeg)

![](https://files.steempeak.com/file/steempeak/minloulou/NzZm4XR1-WhatsApp20Image202019-06-2920at2015.52.24201.jpeg)

**最後最後還有一個很重要的是支持開發者(SUPPORT US)，如果你用得開心，不妨將你收到的STEEM/SBD捐贈給開發者以支持他們繼續努力!!**

![](https://steemitimages.com/0x0/https://files.steempeak.com/file/steempeak/minloulou/JbiMWdr9-image.png)

各位也可以follow @steempeak的page以得到最新的發展，也可以加入他們的discord: https://discord.gg/pC5bgK 發表你的意見~!


## steempress ^[作者:\@honoru;编辑\@robertyan;原文链接:https://steempeak.com/cn/@pet.society/steempress-ke3lnzy6z7]

這幾天有新加入Steem的人查詢 Steempress 的事情，故此特意寫這一帖。而這帖用小號發，而不用主戶口發帖 的原因，便是主戶口 只有 3.5% 的 Steempress 固定點贊。而小號因為在使用 Steempress 初時，每天都寫與 STEM 主題的內容，每帖都在10-30美元收入，因而被判定有 7.5% 以上的固定點贊。利字當頭，這一帖當然是用小號來發。

**Steempress 是甚麼?**

Steempress 是一個建基於 Wordpress 的插件，推出的目的是希望將 Steem推廣至世界各地的 Wordpress 網站站主，讓各站主的Wordpress 在發文章時，可以同步至 Steem。一個簡單的步驟，便可以將 Wordpress 網站內容上傳至區塊鏈，並且獲得 Steem 的Token 收入。

**怎樣安裝?**

只需在 Wordpress 的插件庫內搜索 Steempress 便可以加入。

![](https://honoru.000webhostapp.com/wp-content/uploads/2020/03/image-5.png)

在安裝後，設定十分簡單，只需加入自己的Steem ID 及 Posting Key 便完成。

![](https://honoru.000webhostapp.com/wp-content/uploads/2020/03/image-6.png)

之後，在Wordpress 發帖後，便可以同時同步至 Steem。在 Wordpress 發帖的好處，當然是編輯器十分友善，與及可以自己預定未來發帖時間。

**使用Steempress 有獎勵?**  

對啊！Steempress團隊為鼓勵大家多多使用。故此，所有透過 Steempress 插件發帖的帖子，每天24小時內，可以獲得一次的鼓勵點贊。不過，不同的博主，所獲得的點贊比例會不一樣。

現時大約3.5% - 18% 之間。

**如何獲得高額的Steempress 點贊？**  

Steempress 採用「內容審查再判斷形式」來定一位博主所獲得的「固定點贊比例」，從最低3.5%開始。而判定的原則亦相當簡單，便是透過一位博主的最初幾張 Steempress帖來作判決，所以最初發的帖很重要。

開始使用Steempress 時，基本Steempress 不會來點贊，大約發了 5-10帖後，Steempress團隊會判斷該段時間該博主的帖子質量及積極程度，透過這些判斷而給予不同比例級別。當有了這些級別，以後很少會再改變。

故此，首段時間使用Steempress 插件要注意以下幾點：

一。 開始的十帖，建議字數較多（500-1000 是必須)，另外也加入不同「自己拍攝 / 設計的圖片」，不要使用公眾或網站上搜尋下來的圖片，抄襲是必死；

二。 內容主題可以很多元化，我們發覺旅遊帖較容易獲得比較高的點讚比例；

三。 Steempress為鼓勵博主們持續使用，所以很喜歡看到每天持續發帖。所以在首階段的那5-10張帖子，最好是每天發一帖。不宜多，也不宜少。

在CN區已有大量的博主使用 Steempress 插件同步 Wordpress 與 Steem。故此，有任何問題，可以隨時向大家發問。

最後，有一點要留意。雖然透過Steempress發帖有額外的點贊，但是該帖子Steempress也有抽成。故此，不要在一些高額的帖上使用Steempress，避免抽成的金額比Steempress的點贊更多加而吃虧。而高額帖子的意思，便是該帖本身已經獲得$10 美元以上的點贊。
...
## Dlive——去中心化的视频与直播平台 ^[作者:\@lixing;编辑:\@maiyude;原文链接:https://steemit.com/cn/@lixing/dlive]
...
## Tasteem - 美食分享平台^[作者:\@aaronli, \@deanliu;编辑:\@aaronli;原文链接:https://steemit.com/artnearn/@aaronli/dapptasteemio-l2l53r8rmu, https://steemit.com/cn/@deanliu/tasteem-review-tasteem-wpfnzl9m]
...
Tasteem 網址：http://tasteem.io

<h3>使用tasteem的好處</h3>

1. 有機會得到 [@tasteem](https://steemit.com/@tasteem) 點贊
2. 使用tasteem.io 的收藏功能，收藏自己喜歡的餐廳
3. 增加自己的寫作題材
4. 學習用英文寫作
...
1. 首先我們到 tasteem.io，點擊右上角的「Sign in」，用自己的steemit帳戶登入。
![](https://i.imgur.com/TWZkplc.jpg)

1. 登入後，可瀏覽自己感興趣的主題活動，並了解活動資料。
    1 活動的舉行日期
    2 活動主題
    3 活動距離截止的尚餘時間
    4 活動現時的總獎賞

![](https://i.imgur.com/ceDdjkT.png)

進入活動頁面後，可查看活動的介紹及其他參加者的文章。

![](https://i.imgur.com/Ee7fMBr.png)

點擊最下方的「Post」，即可進入文章編輯頁面。編輯頁面共分幾個部份，第一部份是上載封面圖片。

![](https://i.imgur.com/YIB1DPr.png)
...
1. 一個點贊可獲兩分
2. 文章每得到1 SBD的收益可得10分
3. 文章每得到1個收藏可得3分

另外大家需要留意兩點：

1. 只有曾登入tasteem用戶的點贊才會得到分數
2. 文章收藏得到的分數最多是30分，即10個收藏
3. Tasteem嚴格禁止bidbot，使用bidbot的有可能會被排除資格
...
## Steemitworldmap ^[作者:\@morningshine;编辑:\@jianan;原文链接:https://steemit.com/cn/@morningshine/steemitworldmap-3aefdqt1uu]

在我的另一篇文章《[摄影爱好者Steem社区新手发帖入门](https://busy.org/@morningshine/steem-gt5jkx9uua)》中有提到使用Steemitworldmap能带来额外的收益。但是Steemitworldmap使用方法和标签不太一样，今天我专门写一篇文章来介绍如何使用Steemitworldmap。

<h3>Steemitworldmap是什么？</h3>


Steemitworldmap是一个基于Steem社区和谷歌地图的一个应用，官方网址是：[https://www.steemitworldmap.com/](https://www.steemitworldmap.com/)。

如果你在steem上发旅游贴或风光照片并在这个地图上标记了具体地点，那么在这个地图上将看到你发的帖子。以下便是进入[https://www.steemitworldmap.com/](https://www.steemitworldmap.com/) 看到的界面，你可以大致看到每个地方发帖的数量，有数字的代表改地方不止一篇文章，没有数字的标记代表只有一篇文章，可以点击这些标记查看与这个地方相关的所有帖子。

 ![](http://cnstm.oss-cn-shenzhen.aliyuncs.com/2019/06/20190623022401.jpg)  

<h3>使用Steemitworldmap的好处</h3>

1.  有可能得到\@steemitworldmap的点赞
2.  如果配合旅游帖，有可能入选[Travel Digest](https://steemit.com/@steemitworldmap)，一旦入选，将会得到更大的曝光以及更多人的点赞。
3.  可以按地图来查看自己或某个Steem账号使用过Steemitworldmap的帖子。例如下图通过Filter来筛选：

![](http://cnstm.oss-cn-shenzhen.aliyuncs.com/2019/06/20190623023248.jpg)  

<h3>如何使用Steemitworldmap</h3>
...
1.访问网址：[https://www.steemitworldmap.com/](https://www.steemitworldmap.com/)

2.搜索输入框中输入地址，并且从联想地址中选择一个，如果没有特别精准的也先选择一个，到地理里可以再次调整。

![](https://cdn.steemitimages.com/DQmXph5aAZgLiEfwQnKWaYqe4RPr4tB5p3ZHjvk9pQE3MSf/image.png)  

![](https://cdn.steemitimages.com/DQmXph5aAZgLiEfwQnKWaYqe4RPr4tB5p3ZHjvk9pQE3MSf/image.png)

3.选择地址后，点击地图底部的“code”按钮

![](https://cdn.steemitimages.com/DQmS2Hnp6WxDYYsgJxkCPir4tjHZzKNRF2FEbk9QynKwxYK/image.png)  

![](https://cdn.steemitimages.com/DQmS2Hnp6WxDYYsgJxkCPir4tjHZzKNRF2FEbk9QynKwxYK/image.png)

4.点击你认为正确的地点后，地图下部会显示出一串类似 `[//]:# (!steemitworldmap 31.149316 lat 121.803556 long d3scr)` 的代码，点击这串代码，系统会提示已复制成功

![](https://cdn.steemitimages.com/DQmRAMddBAtTaN9Wyh93imUCeCPPuBVeh4rczUuQYB7B6JN/image.png)  

![](https://cdn.steemitimages.com/DQmRAMddBAtTaN9Wyh93imUCeCPPuBVeh4rczUuQYB7B6JN/image.png)

![](https://cdn.steemitimages.com/DQmchKrSBSx3Ccd5MGqezQd6zaCtLS33zECG4cBmmStoLbt/image.png)  
...
国内访问[https://www.steemitworldmap.com/](https://www.steemitworldmap.com/) 时，你会发现地图是加载不出来的，只有数字，那是因为谷歌被墙了，这时候得采用另一个策略。大家看到上面介绍的我们需要复制粘贴的一串代码中，只有lat（纬度）和long（经度）前面的数字会发生变化，其他都不会变。那么你只要能找到地图的经纬度，来代替下面的代码中的经纬度就可以了，不一定非得打开Steemitworldmap。 
...
国内用户可以通过访问百度坐标拾取系统（网址：[http://api.map.baidu.com/lbsapi/getpoint/index.html](http://api.map.baidu.com/lbsapi/getpoint/index.html)
）来找到对应的经纬度。如下图例子，点击地图的地点，右上角的位置会显示出你点击的地点的经纬度，经度和纬度是以逗号隔开的，你只要分别将其复制出来即可： 

![](https://cdn.steemitimages.com/DQmdMG2WUHCu73SGVPsYL9TRHdk5251Esh28dBqdZyci4gp/image.png)  
...
![](https://cdn.steemitimages.com/DQmPEHUsCrsYnTTk6ryn84wKkAr7TDQ5CdeLuoLVVaH6C2S/image.png)  

![](https://cdn.steemitimages.com/DQmPEHUsCrsYnTTk6ryn84wKkAr7TDQ5CdeLuoLVVaH6C2S/image.png)

接着弹出以下画面后，点击“经纬度及高度”。

![](https://cdn.steemitimages.com/DQmZnHvaCoR5YjMhxKYoBxFPtzvQcdxn3JxsVWdDpy7GGX4/image.png) 

![](https://cdn.steemitimages.com/DQmZnHvaCoR5YjMhxKYoBxFPtzvQcdxn3JxsVWdDpy7GGX4/image.png)

同样的，你在这里可以找到对应的经纬度。

![](https://cdn.steemitimages.com/DQmdLnAqC3dhAj8oegrctsPSZBxFw5N8DKpUwb14fRmepPZ/image.png)  
...
Steemitworldmap除了配合你的旅游帖子和美照之外，发美食应该也可以用，但是应该不会被评选到[Travel Digest](https://steemit.com/@steemitworldmap)，但是据说可能会得到点赞，这个本人没有试过，大家尝试过可以给我反馈确切的答案。


## Steem Bounty之投票俱乐部 ^[作者:\@sonyeye;编辑:\@jianan;原文链接:https://steemit.com/steempress/@sonyeye/steemit-iuvt1g66xr]

![](http://cnstm.oss-cn-shenzhen.aliyuncs.com/2019/06/2-3.jpg)
...
从目前得知的有关SNAX奖励的指标中，主要有评论数量，投票数，被关注的粉丝数等，据说跟steem-ua的指标类似。
