...
\#\#\# 为什么帐号上的SP数量每天都在增长？\footnote{作者：@ericet；原文链接：\url{https://steemit.com/steempress/@ericet/sp-0nzgkme8l3}}
...
\item
  ...
  \#\#\# 帖子收益的计算方式 \footnote{作者：@ericet；原文链接：\url{https://steemit.com/cn/@ericet/35f52g}}\{\#how-to-calculate-reward\}
\end{itemize}
