...
\hypertarget{sp}{%
\subsection[为什么帐号上的SP数量每天都在增长？]{\texorpdfstring{为什么帐号上的SP数量每天都在增长？\footnote{作者：@ericet；原文链接：\url{https://steemit.com/steempress/@ericet/sp-0nzgkme8l3}}}{为什么帐号上的SP数量每天都在增长？}}\label{sp}}
...
\item
  ...
  最初官方为了鼓励Steem用户发现优秀文章，就设计了一个点赞文章越早，得到点赞收益越多的规则。这本身是个很好的规则，但很多用户为了利益钻空子，就制造了很多点赞机器人，可以在文章刚发出来时就点赞文章，获得最大的收益。机器人获得的收益多了，那么自然认真发现优秀文章的用户得到收益就少了。为了减轻机器人抢赞造成的坏处，官方便设计了一个惩罚机制，太早点赞一篇文章则你本该获得点赞收益就会分一些给作者。极端情况下，比如文章发表一分钟内点赞，那么你所有的收益的点赞收益都会放回奖金池。随着时间的延长则返回奖金池的比例减小。直到15分钟后，你就可以获得你所有的点赞收益。所以实际上你发表一篇文章，不管点赞者什么时候点赞，作者都获得75\%收益。而点赞者如果在15分钟内点赞，他们的部分审查收益将放回奖金池。
\item
  4.点赞的时机
  ...
  \item
    二：15分钟后越早点赞越好
  \item
    三：7到15分钟之间任何时候点赞都可能得到最大收益，还是得具体情况具体分析。
  \end{itemize}
...
\hypertarget{how-to-calculate-reward}{%
\subsection[帖子收益的计算方式 ]{\texorpdfstring{帖子收益的计算方式 \footnote{作者：@ericet；原文链接：\url{https://steemit.com/cn/@ericet/35f52g}}}{帖子收益的计算方式 }}\label{how-to-calculate-reward}}

帖子计算的公式
\includegraphics{images/chapter_02_0/image.png}

\includegraphics{images/chapter_02_0/image_1.png}

第一组公式：
\textbf{RS}: 帖子收益总和，以rshares为单位。
\textbf{Rb（Reward Balance)}: 每年Steem通货膨胀所产生的STEEM，大概每3秒产生 1.668 STEEM 加到奖金池里
\textbf{Rc（Recent Claims）}: 所有帖子回复还没有结算的收益总和。以Rshares为单位。
...
\item
  早鸟惩罚：最初官方为了鼓励Steem用户发现优秀文章，就设计了一个点赞文章越早，得到点赞收益越多的规则。这本身是个很好的规则，但很多用户为了利益钻空子，就制造了很多点赞机器人，可以在文章刚发出来时就点赞文章，获得最大的收益。机器人获得的收益多了，那么自然认真发现优秀文章的用户得到收益就少了。为了减轻机器人抢赞造成的坏处，官方便设计了一个惩罚机制，太早点赞一篇文章则你本该获得点赞收益就会分一些给作者。极端情况下，比如文章发表一分钟内点赞，那么你所有的收益的点赞收益都会放回奖金池。随着时间的延长则返回奖金池的比例减小。直到15分钟后，你就可以获得你所有的点赞收益。所以实际上你发表一篇文章，不管点赞者什么时候点赞，作者都获得75\%收益。而点赞者如果在15分钟内点赞，他们的部分审查收益将放回奖金池。
\item
  点赞时机：考虑到早鸟惩罚，我们可以大致推测出1分钟之内不点赞，15分钟后越早点赞越好，1到15分钟之间任何时候点赞都可能得到最大收益，还是得具体情况具体分析。当然，如果你还在看这个章节，很可能你的有效SP还不算太高，那么遇到真心喜欢的文章，过了1分钟后就尽早点赞吧。
\item
  喂价和市场价
\item
  系统不可控因素
...
\hypertarget{steem-201973}{%
\subsection[摄影爱好者Steem社区新手发帖入门 (更新於2019年7月3日)]{\texorpdfstring{摄影爱好者Steem社区新手发帖入门 \footnote{作者：@morningshine 原文链接：\url{https://steemit.com/cn/@morningshine/steem-gt5jkx9uua}} (更新於2019年7月3日)}{摄影爱好者Steem社区新手发帖入门  (更新於2019年7月3日)}}\label{steem-201973}}

\includegraphics{images/chapter_06_0/36E6HBq.png}
...
\hypertarget{steempeak}{%
\section{STEEMPEAK}\label{steempeak}}

\hypertarget{steempeakpc}{%
\subsection[STEEMPEAK的PC版基本使用方法 ]{\texorpdfstring{STEEMPEAK的PC版基本使用方法 \footnote{作者:@minloulou;编辑:@jianan;原文链接:\url{https://steemit.com/steem-guides/@minloulou/steempeak-steempeak}}}{STEEMPEAK的PC版基本使用方法 }}\label{steempeakpc}}
...
\includegraphics{images/chapter_09_0/O6r7PrIX-image.png}

(圖一)

\includegraphics{images/chapter_09_0/9XgbFrEP-image.png}

(圖二)

\includegraphics{images/chapter_09_0/u7mzP5YF-image.png}

(圖三)

\includegraphics{images/chapter_09_0/JxFz4Cnc-image.png}

(圖四)

\includegraphics{images/chapter_09_0/qZXxNxC3-image.png}

(圖五)

成功登入後，\textbf{你可以使用上方的標題開始探索(Feed/Explore)}
- 如Feed是指你跟隨(Follow)的人的最新帖子(圖六)
- Explore則是可以按不同條件去搜索相關的帖子
- 在(圖七)我搜索了\#cn區的最有價值(REWARD)帖子
- 另外你也可以按(REWARD)那個字，彈出菜單去選擇最新(Created)的帖子(圖八)

\emph{我個人最喜歡用這個功能去搜索\#cn-activity的活動，透過參加活動可以令大家快速融入社區。首先當然要Follow \citet{cn-activity的帳號}，然後使用Explore這個功能，再選擇FAVORITE TOPICS(最愛主題)，最後找到最新(Created)的帖子} (圖九)

\includegraphics{images/chapter_09_0/OQ121Xux-image.png}

(圖六)

\includegraphics{images/chapter_09_0/nAV5a7tT-image.png}

(圖七)

\includegraphics{images/chapter_09_0/1qQdH8A1-image.png}

(圖八)

\includegraphics{images/chapter_09_0/gVuhIERD-image.png}

(圖九)

\textbf{在Steemit別忘了寫一寫、分享一下與其他人互動}
- 在STEEMPEAK的右上方找到這支鉛筆後你可以看到(Create a Post)的功能(圖十)
- 在Steemit的寫作需要留意的當然是標題(Post Title)、內容、標籤(tag)、草稿(Draft)和發布(PUBLISH)
- 你可以寫(圖十一)我把需要留意的地方都畫上紅線

\textbf{在STEEMPEAK上寫作是十分安心的}，他會自動幫你儲存草稿(Draft)，作家最怕是花了很多時間，寫了很長的一篇文作後突然因為故障或其作問題而令作品不見了!!!

\includegraphics{images/chapter_09_0/4lQuGS3B-image.png}
(圖十)

\includegraphics{images/chapter_09_0/kESzC7Au-image.png}
(圖十一)

\textbf{最後說一下STEEMPEAK超強大的錢包功能(超強大)}
...
\textbf{好用的功能數之不盡，還請各位努力探索或者期待我未來的帖子！！}

\includegraphics{images/chapter_09_0/zg3O5gG8-image.png}
(圖十二)

\includegraphics{images/chapter_09_0/uwC4Qvzy-image.png}
(圖十三)

\textbf{最後最後還有一個很重要的是支持開發者(SUPPORT US)，如果你用得開心，不妨將你收到的STEEM/SBD捐贈給開發者以支持他們繼續努力!!}

\includegraphics{images/chapter_09_0/JbiMWdr9-image.png}

\hypertarget{steempeak}{%
\subsection[STEEMPEAK的手機版 ]{\texorpdfstring{STEEMPEAK的手機版 \footnote{作者:@minloulou;编辑:@jianan;原文链接:\url{https://steemit.com/steem-guides/@minloulou/25jqmd-steempeak-steempeak}}}{STEEMPEAK的手機版 }}\label{steempeak}}

\href{https://steempeak.com/steem-guides/@minloulou/steempeak-steempeak}{齊齊來玩STEEMPEAK(一) STEEMPEAK的基本使用方法}

昨天寫了STEEMPEAK的基本後, @john371911提問了@STEEMPEAK的手機版,有沒有手機apps, 答案是: 暫時沒有, 但可以使用手機瀏覽器使用@STEEMPEAK的大部份功能。

開啟手機瀏覽器進入@STEEMPEAK的主頁:
\url{https://steempeak.com/}

在右上角點一下後便會彈出Login的選單。手機由於沒有Steem Keychain, 所以使用steemconnect去登入。

\includegraphics{images/chapter_09_0/Z2hTcH1H-WhatsApp20Image202019-06-2920at2015.52.20.jpeg}

\includegraphics{images/chapter_09_0/u2pQKwMZ-WhatsApp20Image202019-06-2920at2015.52.21.jpeg}

\includegraphics{images/chapter_09_0/1FTIWwzQ-WhatsApp20Image202019-06-2920at2015.52.22.jpeg}

\includegraphics{images/chapter_09_0/GcrwTzYN-WhatsApp20Image202019-06-2920at2015.52.22201.jpeg}
...
\includegraphics{images/chapter_09_0/a2kr1eXR-WhatsApp20Image202019-06-2920at2015.52.23201.jpeg}

\includegraphics{images/chapter_09_0/PTspCZ4t-WhatsApp20Image202019-06-2920at2015.52.24.jpeg}

\includegraphics{images/chapter_09_0/Mw1SgUOl-WhatsApp20Image202019-06-2920at2015.52.25.jpeg}
...
\includegraphics{images/chapter_09_0/LA5MyhMp-WhatsApp20Image202019-06-2920at2015.52.23.jpeg}

\includegraphics{images/chapter_09_0/NzZm4XR1-WhatsApp20Image202019-06-2920at2015.52.24201.jpeg}

\textbf{最後最後還有一個很重要的是支持開發者(SUPPORT US)，如果你用得開心，不妨將你收到的STEEM/SBD捐贈給開發者以支持他們繼續努力!!}

\includegraphics{images/chapter_09_0/JbiMWdr9-image_1.png}

各位也可以follow \citet{steempeak的page以得到最新的發展}，也可以加入他們的discord: \url{https://discord.gg/pC5bgK} 發表你的意見\textasciitilde{}!
...
\hypertarget{tasteem---}{%
\section[Tasteem - 美食分享平台]{\texorpdfstring{Tasteem - 美食分享平台\footnote{作者:@aaronli, @deanliu;编辑:@aaronli;原文链接:\url{https://steemit.com/artnearn/@aaronli/dapptasteemio-l2l53r8rmu}, \url{https://steemit.com/cn/@deanliu/tasteem-review-tasteem-wpfnzl9m}}}{Tasteem - 美食分享平台}}\label{tasteem---}}

Tasteem於2018年3月加入Steemit，是基於Steem社區以餐廳為主題的應用，你可以在到不同用戶就不同主題的餐廳介紹。現在已經是Steemit上最出名的餐廳介紹活動舉辦者。截至2019年6月，Tasteem的代理SP已經超過一百萬。
Tasteem每一天都會舉辦一個不同的餐廳主題活動，只要按照要求投稿發文，寫得好的文章就會得到tasteem的點贊。

Tasteem 網址：\url{http://tasteem.io}
...
\tightlist
\item
  有機會得到 \citep{tasteem}(\url{https://steemit.com/@tasteem}) 點贊
\item
  使用tasteem.io 的收藏功能，收藏自己喜歡的餐廳
\item
  增加自己的寫作題材
\item
  學習用英文寫作
...
\def\labelenumi{\arabic{enumi}.}
\item
  首先我們到 tasteem.io，點擊右上角的「Sign in」，用自己的steemit帳戶登入。
  \includegraphics{images/chapter_09_0/TWZkplc.jpg}
\item
  登入後，可瀏覽自己感興趣的主題活動，並了解活動資料。
  1 活動的舉行日期
  2 活動主題
  3 活動距離截止的尚餘時間
  4 活動現時的總獎賞
...
\includegraphics{images/chapter_09_0/ceDdjkT.png}

進入活動頁面後，可查看活動的介紹及其他參加者的文章。

\includegraphics{images/chapter_09_0/Ee7fMBr.png}

點擊最下方的「Post」，即可進入文章編輯頁面。編輯頁面共分幾個部份，第一部份是上載封面圖片。

\includegraphics{images/chapter_09_0/YIB1DPr.png}

第二部份是文章規則，基本上每次活動的規則都是一樣。以下為規則的中文翻譯：
...
\item
  你必須曾在最近親自光顧過該餐廳
\item
  你的文章至少需要有三張照片及八句文字描述
\item
  你發表的餐廳必須符合活動主題
\item
  你的文章必須擁有至少一張你親自拍攝的照片
\item
  如果你使用第三方照片，你必須得到使用許可並在文章列明照片來源
\item
  你必須使用合適的語言（即英語），並不使用任何翻譯工具
\item
  你不能發表任何特許經營（如快餐店、咖啡室及其他）、外賣速遞或外賣自取的食物（筆者按：即是不能寫連鎖店及外賣）
\item
  你不能發表曾於一個月內發表過的餐廳
\end{itemize}

\includegraphics{images/chapter_09_0/dEr6UYS.png}

第三部份就可以開始發表內容了，文章編輯器支援markdown，和Steemit一樣。左方是文字輸入部份，右邊則是預覽部份。至於右下方的WYSIWYG，則是直接在編輯器顯示預覽。

\includegraphics{images/chapter_09_0/JATdxty.png}

第四部份，需要輸入餐廳的名稱、評級、實際的地址和加上標簽。tasteem是預設的標簽，總收可加5個標簽。

\includegraphics{images/chapter_09_0/IGXgMa1.png}

最後點擊「Publish」，你就能在活動文章列表看到自己的文章。

\includegraphics{images/chapter_09_0/KQaqd4Y.png}

Tasteem的評分方法

Tasteem擁有自己的一套評分系統，按分數來決定勝出者。用戶可以三種方法得到分數：
...
\tightlist
\item
  只有曾登入tasteem用戶的點贊才會得到分數
\item
  文章收藏得到的分數最多是30分，即10個收藏
\item
  Tasteem嚴格禁止bidbot，使用bidbot的有可能會被排除資格
\end{enumerate}

結語

tasteem對經常光顧新餐廳的朋友來說是一個很不錯的選擇，大家也不需要害怕要寫英語，其實外國人對非英語為母語的人的文法要求並不高，只要看得懂就行了。大家也不需要寫得長篇大論，只要有8句句子就符要參賽資格。

\hypertarget{steemitworldmap}{%
\section[Steemitworldmap ]{\texorpdfstring{Steemitworldmap \footnote{作者:@morningshine;编辑:@jianan;原文链接:\url{https://steemit.com/cn/@morningshine/steemitworldmap-3aefdqt1uu}}}{Steemitworldmap }}\label{steemitworldmap}}

在我的另一篇文章《\href{https://busy.org/@morningshine/steem-gt5jkx9uua}{摄影爱好者Steem社区新手发帖入门}》中有提到使用Steemitworldmap能带来额外的收益。但是Steemitworldmap使用方法和标签不太一样，今天我专门写一篇文章来介绍如何使用Steemitworldmap。

Steemitworldmap是什么？

Steemitworldmap是一个基于Steem社区和谷歌地图的一个应用，官方网址是：\url{https://www.steemitworldmap.com/}。

如果你在steem上发旅游贴或风光照片并在这个地图上标记了具体地点，那么在这个地图上将看到你发的帖子。以下便是进入\url{https://www.steemitworldmap.com/} 看到的界面，你可以大致看到每个地方发帖的数量，有数字的代表改地方不止一篇文章，没有数字的标记代表只有一篇文章，可以点击这些标记查看与这个地方相关的所有帖子。

\includegraphics{images/chapter_09_0/20190623022401.jpg}
...
\item
  如果配合旅游帖，有可能入选\href{https://steemit.com/@steemitworldmap}{Travel Digest}，一旦入选，将会得到更大的曝光以及更多人的点赞。
\item
  可以按地图来查看自己或某个Steem账号使用过Steemitworldmap的帖子。例如下图通过Filter来筛选：
\end{enumerate}

\includegraphics{images/chapter_09_0/20190623023248.jpg}
...
1.访问网址：\url{https://www.steemitworldmap.com/}

2.搜索输入框中输入地址，并且从联想地址中选择一个，如果没有特别精准的也先选择一个，到地理里可以再次调整。

\includegraphics{images/chapter_09_0/image.png}

\includegraphics{images/chapter_09_0/image_1.png}

3.选择地址后，点击地图底部的``code''按钮

\includegraphics{images/chapter_09_0/image_1_1.png}

\includegraphics{images/chapter_09_0/image_1_1_1.png}

4.点击你认为正确的地点后，地图下部会显示出一串类似 \texttt{{[}//{]}:\#\ (!steemitworldmap\ 31.149316\ lat\ 121.803556\ long\ d3scr)} 的代码，点击这串代码，系统会提示已复制成功

\includegraphics{images/chapter_09_0/image_1_1_1_1.png}

\includegraphics{images/chapter_09_0/image_1_1_1_1_1.png}

\includegraphics{images/chapter_09_0/image_1_1_1_1_1_1.png}

\includegraphics{images/chapter_09_0/image_1_1_1_1_1_1_1.png}
...
国内访问\url{https://www.steemitworldmap.com/} 时，你会发现地图是加载不出来的，只有数字，那是因为谷歌被墙了，这时候得采用另一个策略。大家看到上面介绍的我们需要复制粘贴的一串代码中，只有lat（纬度）和long（经度）前面的数字会发生变化，其他都不会变。那么你只要能找到地图的经纬度，来代替下面的代码中的经纬度就可以了，不一定非得打开Steemitworldmap。

\begin{verbatim}
[//]:# (!steemitworldmap 纬度数字 lat 经度数字 long d3scr
\end{verbatim}

1. PC端

国内用户可以通过访问百度坐标拾取系统（网址：\url{http://api.map.baidu.com/lbsapi/getpoint/index.html}
）来找到对应的经纬度。如下图例子，点击地图的地点，右上角的位置会显示出你点击的地点的经纬度，经度和纬度是以逗号隔开的，你只要分别将其复制出来即可：

\includegraphics{images/chapter_09_0/image_1_1_1_1_1_1_1_1.png}

\includegraphics{images/chapter_09_0/image_1_1_1_1_1_1_1_1_1.png}

\textbf{需要再三注意的是：百度坐标拾取系统是先经度后维度的，而Steemitworldmap的代码是先维度后经度，换句话来说，两者的数字位置是相反的。}
...
\includegraphics{images/chapter_09_0/image_1_1_1_1_1_1_1_1_1_1.png}

\includegraphics{images/chapter_09_0/image_1_1_1_1_1_1_1_1_1_1_1.png}

接着弹出以下画面后，点击``经纬度及高度''。

\includegraphics{images/chapter_09_0/image_1_1_1_1_1_1_1_1_1_1_1_1.png}

\includegraphics{images/chapter_09_0/image_1_1_1_1_1_1_1_1_1_1_1_1_1.png}

同样的，你在这里可以找到对应的经纬度。

\includegraphics{images/chapter_09_0/image_1_1_1_1_1_1_1_1_1_1_1_1_1_1.png}

\includegraphics{images/chapter_09_0/image_1_1_1_1_1_1_1_1_1_1_1_1_1_1_1.png}

将经纬度代替以下代码，并将其复制粘贴到你的帖子的最后即可。
...
Steemitworldmap除了配合你的旅游帖子和美照之外，发美食应该也可以用，但是应该不会被评选到\href{https://steemit.com/@steemitworldmap}{Travel Digest}，但是据说可能会得到点赞，这个本人没有试过，大家尝试过可以给我反馈确切的答案。

\hypertarget{steem-bounty}{%
\section[Steem Bounty之投票俱乐部 ]{\texorpdfstring{Steem Bounty之投票俱乐部 \footnote{作者:@sonyeye;编辑:@jianan;原文链接:\url{https://steemit.com/steempress/@sonyeye/steemit-iuvt1g66xr}}}{Steem Bounty之投票俱乐部 }}\label{steem-bounty}}

\includegraphics{images/chapter_09_0/2-3.jpg}
